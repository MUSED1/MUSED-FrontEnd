...
export function CollectionsNY() {
    ...
    const fetchClothingItems = async () => {
        try {
            ...
            // This fetches items uploaded in April 2026 only (April 1 - April 30)
            ...
            while (hasMore) {
                const response = await axios.get(`${API_URL}/clothing/admin/all`, {
                    ...
                    params: {
                        status: 'available',
                        from: '2026-04-01',  // April 1, 2026
                        to: '2026-04-30',    // April 30, 2026
                        page,
                        limit: 50
                    }
                });
    ...
    const filterItems = () => {
        // Date (April 1-30, 2026) and status (available) are filtered server-side.
                ...
                <main className="min-h-screen bg-gradient-to-br from-cream to-amber-50 py-8">
                    <div className="container mx-auto px-4 max-w-7xl text-center">
                        <div className="bg-white rounded-2xl shadow-lg p-12">
                            ...
                            <p className="text-plum">Loading NY collection...</p>
                        </div>
                    </div>
                </main>
                <Footer />
                ...
                <div className="container mx-auto px-4 max-w-7xl">
                    ...
                    <div className="text-center mb-12">
                        ...
                        <p className="text-lg text-plum/80 max-w-2xl mx-auto">
                            Discover our NY-inspired collection. Choose your item and receive it at your door.
                        </p>
                    </div>
