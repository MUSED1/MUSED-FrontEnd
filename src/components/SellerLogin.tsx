...
//
// Visually this now shares the exact same editorial split-panel layout as
// Login.tsx (same AuthImagePanel, glass inputs, gradient pill button) —
// only the copy, badge, and seller-specific redirect logic differ.
