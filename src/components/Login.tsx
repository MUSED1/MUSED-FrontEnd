            ...
            <div className="max-w-md w-full">
                ...
                <div className="bg-white/90 backdrop-blur-sm rounded-3xl shadow-2xl p-8 md:p-10 border border-gold/20">
                    <div className="text-center mb-8">
                        <h2 className="font-serif text-5xl md:text-6xl text-burgundy mb-3 tracking-tight">
                            Welcome Back
                        </h2>
                        <p className="text-plum/70 text-base" style={{ fontFamily: 'Inter, sans-serif' }}>
                    ...
                    <form className="space-y-5" onSubmit={handleSubmit}>
                        {localError && (
                            <div className="bg-red-50 border border-red-200 text-red-600 px-5 py-4 rounded-2xl text-sm flex items-start gap-3" style={{ fontFamily: 'Inter, sans-serif' }}>
                        ...
                        <div className="space-y-4">
                            {/* Email Field */}
                            <div>
                                <label className="block text-sm font-medium text-plum/80 mb-1.5" style={{ fontFamily: 'Inter, sans-serif' }}>
                                    Email Address
                                </label>
                                <input
                                    name="email"
                                    type="email"
                                    required
                                    className="w-full px-5 py-3.5 bg-gray-50 border border-gray-200 rounded-xl text-plum placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-burgundy/20 focus:border-burgundy transition-all duration-200"
                    ...
                    <div className="mt-8">
                        <div className="relative">
                            ...
                            <div className="relative flex justify-center text-sm">
                                <span className="px-4 bg-white text-plum/60" style={{ fontFamily: 'Inter, sans-serif' }}>
                                    Or continue with
                                </span>
                            </div>
                        </div>
                        ...
                        <div className="mt-6 grid grid-cols-2 gap-3">
                            ...
                            >
                                ...
                                <span className="text-sm text-plum" style={{ fontFamily: 'Inter, sans-serif' }}>Google</span>
                            </button>
                            ...
                            >
                                ...
                                <span className="text-sm text-plum" style={{ fontFamily: 'Inter, sans-serif' }}>Facebook</span>
                            </button>
                        </div>
                    </div>
